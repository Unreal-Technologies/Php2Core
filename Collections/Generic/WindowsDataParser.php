...
namespace Php2Core\Collections\Generic;

class WindowsDataParser extends \Php2Core\Collections\Dictionary
{
    /**
     * @param string $header
     * @param string $data
    ...
    {
        $list = (new \Php2Core\Collections\Linq(explode(' ', $indentations)))
            -> toArray(function ($x) {
                return $x !== '';
            });
