...
namespace Php2Core\Data\Collections\Generic;

class WindowsDataParser extends \Php2Core\Data\Collections\Dictionary
{
    /**
     * @param string $header
     * @param string $data
    ...
    {
        $list = (new \Php2Core\Data\Collections\Linq(explode(' ', $indentations)))
            -> toArray(function ($x) {
                return $x !== '';
            });
